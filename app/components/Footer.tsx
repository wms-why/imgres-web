      ...
      <div className='w-full mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='flex '>
          <div className='w-1/3'>
            ...
            <p className='text-sm mb-4'>Professional image resizing tool for all your needs.</p>
            <div className='flex gap-4'>
              <a href='https://github.com/wms-why/imgres-web' target='_blank' rel='noopener noreferrer' className='text-sm hover:text-white transition-colors'>
                <svg role='img' width='32' height='32' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' style={{ filter: 'invert(1)' }}>
                  <title>GitHub</title>
              ...
              <a href='https://t.me/+W1kcVrb-cQU5NWFh' target='_blank' rel='noopener noreferrer' className='text-sm hover:text-white transition-colors'>
                <svg role='img' width='32' height='32' style={{ filter: 'invert(1)' }} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='w-2/3 flex justify-arround gap-24 '>
            ...
            <div>
              ...
              <ul className='space-y-3 text-sm'>
                <li>{/* <a href="/price" className="hover:text-white transition-colors">Price</a> */}</li>
                <li>
                  <a href='/#effect-comparison' className='hover:text-white transition-colors'>
                    Effect Comparison
                  </a>
                </li>
                <li>
        ...
        <div className='mt-12 pt-8 border-t border-gray-800 text-sm text-center'>
          ...
          <p className='mt-2'>
            Contact:{' '}
            <a href='mailto:support@imgres.online' className='hover:text-white transition-colors'>
              support@imgres.online
            </a>
          </p>
        </div>
      </div>
